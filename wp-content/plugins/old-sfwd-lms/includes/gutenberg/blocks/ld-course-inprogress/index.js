...
registerBlockType(
    ...
    {
        title: sprintf( _x( 'LearnDash %s In Progress', 'LearnDash Course Complete', 'learndash' ), ldlms_settings['settings']['custom_labels']['course'] || 'course' ),
        description: sprintf( _x( 'LearnDash %s In Progress Block', 'LearnDash Course In Progress Block', 'learndash' ), ldlms_settings['settings']['custom_labels']['course'] || 'course' ),
        //icon: icon,
        category: 'widgets',
        attributes: {
            course_id: {
