    ...
    ';
        ...
        echo ' </div><div class="clearfix"></div>
            <div class="col-md-12" id="lfb_finalStepFields" >
                            <p style="text-align: left; float: right; margin-bottom: -4px;" ><a href="javascript:" id="lfb_addFieldBtn" onclick="lfb_editItem(0);" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" ></span>' . __('Add a field', 'lfb') . ' </a></p>
        ...
        echo '<div role="tabpanel" class="tab-pane" id="lfb_tabDesign" >
                    ...
                    <div class="col-md-4">
                                ...
                                <div class="form-group" >
                                   ...
                                   <label>&nbsp;</label>
                                   <a href="https://www.google.com/fonts" style="margin-top: 8px;margin-bottom: 17px;" target="_blank" class="btn btn-default"><span class="glyphicon glyphicon-list"></span>' . __('See Google fonts', 'lfb') . '</a>        
                               </div>
                               <div class="form-group" >
                              ...
                              <div class="form-group" >
                                 ...
                                 <div class="form-group" >
                                    <label> ' . __('Style of image titles', 'lfb') . ' </label >
                                     <select type="number" name="imgTitlesStyle" class="form-control" style="width: 100%;">
...
if(([item-3_quantity] >5) ) {
	([item-3_price]/2)*([item-1_quantity])
        ...
        echo '<p style="text-align: right; margin: 0px;"><a href="javascript:" id="lfb_btnAddRichtextValue" onclick="lfb_addEmailValue(2);" class="btn btn-default" style="margin-bottom: 8px;"><span class="glyphicon glyphicon-plus"></span>Get the value of a field</a></p>';
    ...
    public function resetReference() {
        if (current_user_can('manage_options')) {
            ...
            $formID = sanitize_text_field($_POST['formID']);
            $table_name = $wpdb->prefix . "wpefc_forms";
            $wpdb->update($table_name, array('current_ref' => 1), array('id' => $formID));
        }
        die();
    }
