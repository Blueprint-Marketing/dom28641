...
function wpe_initForms() {
    jQuery.each(wpe_forms, function () {
        ...
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]  #mainPanel .genSlide .lfb_datepicker').datepicker("option",
                "dateFormat", dateFormat);
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] .lfb_datepicker').each(function () {
        ...
        jQuery.each(items, function () {
            ...
            if (item.label != undefined && item.label != "" && item.label != "undefined") {
                ...
                if (item.stepid != 'final' || form.summary_hideFinalStep != '1') {
                    ...
                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #lfb_summary table tbody #lfb_summaryDiscountTr').before('<tr data-itemstep="' + item.stepid + '" class="' + itemClass + ' ' + hideClass + '"><td>' + item.label + '</td><td class="lfb_valueTd ' + classIsFile + '">' + value + '</td><td class="lfb_quantityTd ' + cssQt + '">' + itemQt + '</td><td class="lfb_priceTd ' + priceClass + '">' + itemPrice + '</td></tr>');
                }
            }
        });
                            ...
                            if ($valueItem.length > 0) {
                                if (attribute == '') {
                                    ...
                                    if ($valueItem.is('.lfb_datepicker')) {
                                        condition.value = jQuery.datepicker.formatDate("yy-mm-dd", $valueItem.datepicker("getDate"));
                                    }
                                    ...
                                    if (jQuery(this).data('operation') == '-') {
                                        ...
                                        if (reducIndex >= 0) {
                                            ...
                                            if (form.currencyPosition == 'left') {
                                                ...
                                                if (jQuery(this).find('.quantityBtns').is('.open') && form.imgTitlesStyle == '' /* || (jQuery(this).is('.checked') && jQuery(this).find('.wpe_itemQtField').length > 0)*/) {
                                                    if (form.disableTipMobile == 0 || !wpe_is_touch_device()) {
...
function lfb_updateRichTextValues(formID) {
    ...
    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] .lfb_richtext[data-itemid]').each(function () {
        ...
        if (form.richtextsContent[jQuery(this).attr('data-itemid').toString()] !== undefined) {
            ...
            content = content.replace(/\[total\]/g, jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"]  #finalPrice').html());
            content = content.replace(/\[total_quantity\]/g, wpe_getTotalQuantities(formID, _stepID));
