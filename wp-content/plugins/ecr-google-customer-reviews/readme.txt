...
You can use the filter hook called 'gcr_delivery_days'.
...
= 2.6.12 =
* Bug fix with ecr_show_gcr_badge filter hook.

= 2.6.11 =
* Fix compatibility with 3rd party plugins.  Switched meta keys back to _gtin instead of _gtin_variation for product variations.

= 2.6.10 =
* Added hook into get_post_meta to fallback _gtin to _gtin_variation if empty

= 2.6.9 =
* Added the gcr_delivery_days filter hook

= 2.6.8 =
* Fix bug with GTINs on variable products

= 2.6.7 =
* Added support for using SKU as the GTIN

= 2.6.6 =
* Added setting to Disable Popup in My Account > View Order
* Added more descriptions and information to the settings page

= 2.6.5 =
* Bug fix: check for Array() gtin value

= 2.6.4 =
* Bug fix: fallback to substr() if mb_strimwidth() isn't available
