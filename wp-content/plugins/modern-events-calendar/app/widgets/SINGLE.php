...
class Mec_Single_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			__( 'MEC Single Sidebar Items', $this->get_widget_slug() ),
			array(
	...
	public function widget( $args, $instance ) {
        ...
        // our data
        $data_time = ( ! empty( $instance['data_time'] ) ) ? $instance['data_time'] : '';
        $local_time = ( ! empty( $instance['local_time'] ) ) ? $instance['local_time'] : '';
        $event_cost = ( ! empty( $instance['event_cost'] ) ) ? $instance['event_cost'] : '';
        $more_info = ( ! empty( $instance['more_info'] ) ) ? $instance['more_info'] : '';
        $event_label = ( ! empty( $instance['event_label'] ) ) ? $instance['event_label'] : '';
        $event_location = ( ! empty( $instance['event_location'] ) ) ? $instance['event_location'] : '';
        $event_categories = ( ! empty( $instance['event_categories'] ) ) ? $instance['event_categories'] : '';
        $event_orgnizer = ( ! empty( $instance['event_orgnizer'] ) ) ? $instance['event_orgnizer'] : '';
        $register_btn = ( ! empty( $instance['register_btn'] ) ) ? $instance['register_btn'] : '';
        $attende_module = ( ! empty( $instance['attende_module'] ) ) ? $instance['attende_module'] : '';
        $next_module = ( ! empty( $instance['next_module'] ) ) ? $instance['next_module'] : '';
        $links_module = ( ! empty( $instance['links_module'] ) ) ? $instance['links_module'] : '';
	...
	?>
		...
		<ul class="mec-sortable">
			...
			<li>
				<label for="<?php echo $this->get_field_id( 'attende_module' ); ?>"><?php _e( 'Attende Module : ', 'mec' ); ?></label>
	...
	public function update( $new_instance, $old_instance ) {
        ...
        if ( isset($alloptions['Mec_Single_Widget']) )
            delete_option('Mec_Single_Widget');
