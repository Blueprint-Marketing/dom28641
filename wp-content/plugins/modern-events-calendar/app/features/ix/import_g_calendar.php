...
<div class="wrap" id="mec-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="<?php echo $this->main->add_qs_var('tab', 'MEC-import'); ?>" class="nav-tab"><?php echo __('Third Party Plugins', 'mec'); ?></a>
    </h2>
                            ...
                            <ul id="mec_import_g_calendar_events">
                                ...
                                <li>
                                    <label>
                                        ...
                                        <span><?php echo sprintf(__('Event Title: %s Event Date: %s - %s', 'mec'), '<strong>'.$event['title'].'</strong>', '<strong>'.($date_start->format('Y-m-d H:i:s')).'</strong>', '<strong>'.($date_end->format('Y-m-d H:i:s')).'</strong>'); ?></span>
                                    </label>
                                </li>
                                <?php endforeach; ?>
                            </ul>
