...
class MEC_render extends MEC_base
{
    ...
    public function vcategory($atts = array())
    {
        ...
        if($settings['default_skin_category'] == 'full_calendar') $content = $this->vfull($atts);
        elseif($settings['default_skin_category'] == 'yearly_view') $content = $this->vyear($atts);
        ...
        elseif($settings['default_skin_category'] == 'agenda') $content = $this->vagenda($atts);
