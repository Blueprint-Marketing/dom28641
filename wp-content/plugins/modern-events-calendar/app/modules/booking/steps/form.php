...
?>
<form id="mec_book_form" class="mec-booking-form-container" novalidate="novalidate">
    ...
    <ul class="mec-book-tickets-container">
        ...
        <li class="mec-first-for-all-wrapper">
            <label>
                ...
                <input type="checkbox" name="book[first_for_all]" value="1" checked="checked" id="mec_book_first_for_all" onchange="mec_toggle_first_for_all();" />
