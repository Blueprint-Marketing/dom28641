			...
			<?php } else { ?>
				...
				<div class="mui-col-md-6 mui-col-md-offset-3" style="padding-top:1%;">
					<div class="mui-panel">
						...
						<form dummy=">" action="<?php echo $this->bvmain->appUrl(); ?>/home/mc_signup" onsubmit="document.getElementById('get-started').disabled = true;" style="padding-top:10px;"	method="post" name="signup">
