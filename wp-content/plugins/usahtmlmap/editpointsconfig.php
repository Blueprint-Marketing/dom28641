...
<script>
    ...
    $('select[name=map_id],select[name=state_select]').change(function() {
        ...
        s_id = $('select[name=state_select] option:selected').val();
            ...
            location.href='admin.php?page=usa-html5-map-points&map_id='+$('select[name=map_id] option:selected').val()+'&s_id='+s_id;
        });
...
<form method="POST" class="usa-html5-map main" onsubmit="adjustSubmit()">
    ...
    <?php usa_html5map_plugin_nav_tabs('points', $map_id); ?>
    ...
    <div style="display: none" id="dialogs">
        ...
        <?php } ?>
            ...
            <div style="border-top: 1px solid #ddd">
                <label style="position: relative; top: -13px; background: white"><a href="javascript:void(0);" onclick="show_comment(this.innerHTML.indexOf('+')!==-1)"><?php echo sprintf(__("Comment [%s]", "usa-html5-map"), "<span>+</span>") ?></a></label>
            ...
            <label><input type="radio" name="clickaction" id="ca-nothing" value="nothing" checked="checked"/> <?php echo __('nothing', 'usa-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <label><input type="radio" name="clickaction" id="ca-url"     value="url"  /> <?php echo __('open link', 'usa-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <label><input type="radio" name="clickaction" id="ca-info"    value="info" /> <?php echo __('show additional information', 'usa-html5-map') ?></label>&nbsp;&nbsp;&nbsp;
            <br>
            ...
            var btnAdd = {
                ...
                'click' : function() {
                    ...
                    if (act == 'url') {
                        ...
                        link = 'javascript:usahtml5map_set_state_text<?php echo "_$map_id" ?>("'+p+'");';
                        info = editorGet();
                    } else {
                        link = null;
                    }
            ...
            var btnSave = {
                ...
                'click' : function() {
                    ...
                    if (act == 'url') {
                        ...
                        link = 'javascript:usahtml5map_set_state_text<?php echo "_$map_id" ?>("'+activePoint+'");';
                        info = editorGet();
                    } else {
                        link = null;
                    }
