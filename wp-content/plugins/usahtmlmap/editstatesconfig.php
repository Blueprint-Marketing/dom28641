...
<form method="POST" class="usa-html5-map main" onsubmit="adjustSubmit()">
    ...
    <fieldset>
        ...
        <label><input type="radio" name="URLswitch[<?php echo $vals['id']?>]" id="n<?php echo $vals['id']?>" value="nill" <?php echo $rad_nill?> >&nbsp;<?php echo __('Nothing', 'usa-html5-map'); ?></label> <span class="tipsy-q" original-title="<?php esc_attr_e('Do not react on mouse clicks', 'usa-html5-map'); ?>">[?]</span>&nbsp;&nbsp;&nbsp;
        <!--label><input type="radio" name="URLswitch[<?php echo $vals['id']?>]" id="d<?php echo $vals['id']?>" value="def" <?php echo $rad_def?> >&nbsp;<?php echo __('Show popup balloon on the map', 'usa-html5-map'); ?></label> <span class="tipsy-q" original-title="<?php esc_attr_e('Display a popup balloon with the specified information', 'usa-html5-map'); ?>">[?]</span-->&nbsp;&nbsp;&nbsp;
        <label><input type="radio" name="URLswitch[<?php echo $vals['id']?>]" id="o<?php echo $vals['id']?>" value="other" <?php echo $rad_other?> >&nbsp;<?php echo __('Open a URL', 'usa-html5-map'); ?></label> <span class="tipsy-q" original-title="<?php esc_attr_e('A click on this area opens a specified URL', 'usa-html5-map'); ?>">[?]</span>&nbsp;&nbsp;&nbsp;
        <label><input type="radio" name="URLswitch[<?php echo $vals['id']?>]" id="m<?php echo $vals['id']?>" value="more" <?php echo $rad_more?> >&nbsp;<?php echo __('Show more info', 'usa-html5-map'); ?></label> <span class="tipsy-q" original-title="<?php esc_attr_e('Displays a side-panel with additional information (contacts, addresses etc.)', 'usa-html5-map'); ?>">[?]</span><br />
