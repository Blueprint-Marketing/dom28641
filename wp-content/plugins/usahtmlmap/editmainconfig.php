...
<hr>
        ...
        <div style="float: left; width: 50%;">
        <span class="title"><?php echo __('Shadow width:', 'usa-html5-map'); ?> </span><input class="span2" type="text" name="options[shadowWidth]" value="<?php echo (isset($options[$map_id]['shadowWidth'])&&(float)($options[$map_id]['shadowWidth']))? (float)($options[$map_id]['shadowWidth']) : 1.5; ?>" />
