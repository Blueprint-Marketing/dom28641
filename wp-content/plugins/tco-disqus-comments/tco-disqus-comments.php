...
define( 'TCO_DISQUS_COMMENTS_VERSION', '2.0.3' );
...
function x_tco_disqus_comments_menu() {
  add_submenu_page( 'x-addons-home', __( 'Disqus Comments', '__tco__' ), __( 'Disqus Comments', '__tco__' ), 'manage_options', 'tco-extensions-disqus-comments', 'tco_disqus_comments_options_page' );
}

$theme = wp_get_theme(); // gets the current theme
$is_pro_theme = ( 'Pro' == $theme->name || 'Pro' == $theme->parent_theme );
$is_x_theme = function_exists( 'CS' );
add_action( 'admin_menu', ( $is_pro_theme || $is_x_theme ) ? 'x_tco_disqus_comments_menu' : 'tco_disqus_comments_menu', 100 );
