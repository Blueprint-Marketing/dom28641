jQuery(document).ready(function($){	
	// Split AR Code	
	$('#pm-thirtyx-optin-form').on('keyup change', function() {
				change_selects();
				//alert("?");
		  //return false;
		});
		...
		function change_selects(){
				var tags = ['a','iframe','frame','frameset','script'], reg, val = $('#pm-thirtyx-optin-form').val(),
				...
				$(':input[type=email]',hdn).each(function(){
					var email_field = $(this).attr('name');
					$('#ar_email').val(email_field);
				});
