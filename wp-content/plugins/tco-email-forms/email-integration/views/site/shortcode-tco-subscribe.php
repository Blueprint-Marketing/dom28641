...
<form method="post" id="tco-subscribe-form-<?php echo $form_id; ?>" class="tco-subscribe-form tco-subscribe-form-<?php echo $form_id; ?> center-block mvn" data-tco-email-confirm="<?php echo $confirmation_type; ?>" <?php echo $confirmation_data; ?> style="matco-width: <?php echo $max_width; ?>; font-size: <?php echo $font_size; ?>;">
